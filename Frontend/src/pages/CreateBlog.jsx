  ...
  return (
    <div className="max-w-3xl mx-auto mb-20 font-dancing">
      ...
      <form
        ...
        className={`p-8 rounded-xl border space-y-6 ${isDarkMode ? 'bg-[#1e1e1e] border-gray-700' : 'bg-white border-gray-200'}`}
      >
        <div>
          <label className="text-sm font-bold mb-1 block text-gray-500">
            Title
          </label>
          <input
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, topicColor: e.target.value })
              }
        ...
        <button
          disabled={loading}
          className="w-full py-3 bg-[#f97316] text-white font-bold rounded-lg hover:bg-orange-600 disabled:opacity-50 flex justify-center"
        >
