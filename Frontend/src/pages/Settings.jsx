    ...
    <div className="font-dancing max-w-2xl mx-auto space-y-8 mb-20 relative">
      ...
      <div className={`rounded-xl border overflow-hidden shadow-sm ${cardBg}`}>
        ...
        <Link
          ...
          className={`block p-6 border-b ${separator} ${itemHover} transition-colors`}
        >
        ...
        <div className={`p-6 border-b ${separator}`}>
          <h2
            className={`text-sm font-bold uppercase tracking-wider mb-4 text-gray-500`}
          >
            Appearance
          </h2>
          <div className="flex items-center justify-between">
        ...
        <div className={`p-6 border-b ${separator}`}>
          ...
          <div className="space-y-1">
            ...
            <button
              ...
              className={`w-full flex items-center justify-between p-3 rounded-lg ${itemHover} transition-colors text-left`}
            >
              <div className="flex items-center gap-3">
      ...
      {showPrivacyModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div
            className={`relative w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden ${modalBg} border ${separator}`}
          >
            {/* Header */}
            <div
              className={`px-6 py-4 border-b ${separator} flex items-center justify-between`}
            >
              <h3
              ...
              <button
                ...
                className={`p-2 rounded-full ${itemHover} ${subText}`}
              >
                <X size={20} />
              </button>
            </div>
            ...
            {/* Content */}
            <div
              className={`p-6 max-h-[60vh] overflow-y-auto custom-scrollbar space-y-4 ${subText} text-sm leading-relaxed`}
            >
              <p>
                <strong>1. Data Collection:</strong> We collect minimal data
                necessary to provide our services, including your username,
                email, and recipe preferences.
              </p>
              <p>
                <strong>2. User Content:</strong> Any recipes, images, or
                comments you upload remain your intellectual property, but you
                grant us a license to display them on the platform.
              </p>
              <p>
                <strong>3. Security:</strong> We use industry-standard
                encryption to protect your data. Your password is hashed and
                never stored in plain text.
              </p>
              <p>
                <strong>4. Cookies:</strong> We use cookies to maintain your
                session and preference settings (like Light/Dark mode).
              </p>
              <p>
                <strong>5. Third Parties:</strong> We do not sell your personal
                data to advertisers. Analytics are used solely to improve app
                performance.
              </p>
