...
export const FilterDropdown = ({
  ...
  const activeClass = isActive
    ? 'border-[#f97316]/50 bg-[#f97316]/5 text-[#f97316] ring-1 ring-[#f97316]/20'
  ...
  return (
    <div className="relative " ref={dropdownRef}>
      ...
      >
        ...
        <ChevronDown
          size={14}
          className={`transition-transform duration-200 ${isOpen ? 'rotate-180 text-[#f97316]' : 'opacity-50'}`}
        />
      </button>
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-3 py-2.5 text-sm rounded-lg transition-colors text-left ${
                    isSelected
                      ...
                      : `  ${isDarkMode ? 'text-gray-300 hover:bg-gray-800' : 'hover:bg-gray-100 text-gray-700'}`
                  }`}
                >
                  {optLabel}
