...
const ProfileSkeleton = () => {
  ...
  return (
    <div
      className={`min-h-screen ${isDarkMode ? 'bg-[#121212]' : 'bg-gray-50'} pb-20`}
    >
      {/* Cover Image */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-10">
        <div
          className={`rounded-3xl shadow-xl overflow-hidden border ${bgClass}`}
        >
          ...
          {/* Tabs */}
          <div
            className={`flex border-t ${isDarkMode ? 'border-gray-800' : 'border-gray-100'}`}
          >
            {[1, 2, 3].map((i) => (
