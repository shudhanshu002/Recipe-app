...
const ReactionPicker = ({ onReact, onClose }) => {
    const emojis = ['👍', '❤️', '😂', '😮', '😢', '😡'];
    return (
        <div className="absolute bottom-10 right-0 bg-white dark:bg-gray-800 shadow-xl border border-gray-200 dark:border-gray-700 rounded-full p-2 flex gap-2 animate-in fade-in zoom-in duration-200 z-50">
            {emojis.map((emoji) => (
                <button
                    key={emoji}
                    onClick={(e) => {
                            ...
                            <div className="flex gap-3 items-center">
                                ...
                                <div className="flex-1 relative">
                                    <input
                                        ...
                                        className={`w-full px-4 py-2 pr-10 rounded-full border text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all ${inputBg}`}
                                        autoFocus
                                    ...
                                    <button
                                        ...
                                        disabled={isPosting}
                                        className="absolute right-1.5 top-1.5 p-1.5 bg-primary text-white rounded-full hover:bg-orange-600 disabled:opacity-50 transition-colors"
                                    >
                                        <Send size={14} />
                                    </button>
                                </div>
