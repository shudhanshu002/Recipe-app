    ...
    <section className="py-2 px-4 font-dancing">
      ...
      >
        ...
        <div className="relative shrink-0 group">
          ...
          <div
            className={`absolute -top-2 -right-2 p-2 rounded-full shadow-sm text-2xl animate-bounce z-20 ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}
          >
            👨‍💻
          </div>
        </div>
        ...
        <div className="flex-1 text-center md:text-left space-y-4 z-10">
          <div>
            <h5 className="text-[#f97316] font-bold tracking-wider uppercase text-sm mb-1">
          ...
          <div className="relative">
            ...
            <p
              className={`text-lg italic leading-relaxed ${textColor} opacity-80 md:pl-6`}
            >
              {quote}
            </p>
          </div>
