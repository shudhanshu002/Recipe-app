      ...
      <div className="flex gap-3 group">
        ...
        <div className="flex-1">
          ...
          <div className={`p-3 rounded-2xl rounded-tl-none ${styles.cardBg}`}>
            ...
            <p className={`text-sm ${styles.subText} whitespace-pre-wrap`}>
              {comment.content}
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 mt-1 ml-2">
            ...
            {user && (
              <button
                ...
                className="text-xs text-gray-500 hover:text-[#f97316] font-medium flex items-center gap-1"
              >
          ...
          {isReplying && (
            <div className="mt-3 animate-in fade-in slide-in-from-top-2">
              <div className="flex gap-2 items-end">
                <div
                  className={`flex-1 rounded-xl border p-2 ${styles.cardBg} ${isDarkMode ? 'border-gray-600' : 'border-gray-300'}`}
                >
                  <textarea
                    autoFocus
                    value={replyText}
