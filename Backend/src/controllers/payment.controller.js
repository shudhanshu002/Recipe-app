...
export const getRazorpayKey = asyncHandler(async (req, res) => {
    return res.status(200).json(new ApiResponse(200, { key: process.env.RAZORPAY_KEY_ID }, 'Key fetched'));
});
...
export const verifyPayment = asyncHandler(async (req, res) => {
    ...
    if (expectedSignature === razorpay_signature) {
        ...
        return res.status(200).json(new ApiResponse(200, updatedUser, 'Payment verified & Premium activated'));
    } else {
